...
export default async function MatchupData() {
  ...
  const REACT_APP_LEAGUE_ID: string | null = "864451723991863296";
    ...
    for (const roster of rostersData) {
      ...
      for (const matchup of scheduleData) {
        ...
        if (roster.roster_id === matchup.roster_id) {
          updatedScheduleData[roster.owner_id].matchup_id = matchup.matchup_id;
