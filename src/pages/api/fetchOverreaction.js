...
export default async function handler(req, res) {
  ...
  try {
    ...
    const question = `Write an article that is overly praising 3 random teams from the league, making each team seem like they're the CLEAR best team in the league and will win it all. Write like you're seeking the team owner's approval while comedically turning a blind eye to their shortcomings. keep each section short. Make title short and creative. Use a casual and entertaining tone when writing the article.
