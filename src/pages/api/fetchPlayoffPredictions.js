...
export default async function handler(req, res) {
  ...
  "paragraph6": "",
  "paragraph7": ""
with no more than one paragraph for each team that are concise, include playoff chances and predictions as a part of the paragraph. Please ensure that the generated JSON response meets the specified criteria without any syntax issues or inconsistencies. {leagueData} `;
