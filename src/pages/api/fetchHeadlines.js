...
export default async function handler(req, res) {
  ...
  try {
    ...
    const question = `{leagueData} give me 3 sports style headlines recapping this weeks matchups, include their star players on their team who scored the most points for them, their win-loss record and who won by comparing their team points, who ever had more team points in that matchup won the game, please ensure accuracy when stating who won and who lost. include a bit of humor and be creative. pick any 3 matchups to cover and make title's creative and exciting. I want the information to be in this format exactly headline: 
  "id": "",
  "category": "",
  "title": "",
  "description": ""
