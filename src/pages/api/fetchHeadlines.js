...
export default async function handler(req, res) {
  ...
  try {
    ...
    const question = `give me 3 sports style headlines about the league's data, include team names & by team names i mean user names,  a preview and look ahead of their respective matchup and positional matchups. highlight the matchup of their starters as well. include a bit of humor as well. I want the information to be in this format exactly headline =
  "id": "",
  "category": "",
  "title": "",
  "description": ""
